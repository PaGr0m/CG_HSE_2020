    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // Calculate albedo by projecting _XAlbedo, _YAlbedo, _ZAlbedo on world position.
                // Asjust texel to world space ratio using _Scale.
                i.wPos *= _Scale;

                fixed4 albedo =
                    tex2D(_XAlbedo, i.wPos.yz) * i.normal.x * i.normal.x +
                    tex2D(_YAlbedo, i.wPos.xz) * i.normal.y * i.normal.y +
                    tex2D(_ZAlbedo, i.wPos.xy) * i.normal.z * i.normal.z;
